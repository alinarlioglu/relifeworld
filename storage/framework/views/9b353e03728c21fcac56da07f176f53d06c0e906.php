<?php if(!(\Illuminate\Support\Facades\Auth::guard('members')->check())): ?>
    ...
    <?php echo $__env->make('home.components.registration', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#login_submit').on('click', function(event) {
        ...
        $.ajax({
            url: '<?php echo e(route('member.login')); ?>',
            method: 'POST',
            data: {
...
</script><?php /**PATH C:\Users\alina\relifeworld\resources\views/home/components/login.blade.php ENDPATH**/ ?>