...
<div id="filter" class="filter-container">
    ...
    <div class="filter-genre-container">
        <ul>
            <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <input type="checkbox" name="genre" id="<?php echo e($genre->name); ?>" value="<?php echo e($genre->id); ?>" >
                    <label for="<?php echo e($genre->name); ?>"><?php echo e($genre->name); ?></label>
                </li>
    ...
    <div class="filter-exclude-genre-container">
        <ul>
            <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <input type="checkbox" name="excludeGenre" id="exclude_<?php echo e($genre->name); ?>" value="<?php echo e($genre->id); ?>" >
                    <label for="exclude_<?php echo e($genre->name); ?>"><?php echo e($genre->name); ?></label>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
    </div>
...
</div><?php /**PATH C:\Users\alina\relifeworld\resources\views/search/components/filter.blade.php ENDPATH**/ ?>