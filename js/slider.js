...
(function($) {	
    $.widget('ui.slider', $.ui.mouse, {
        ...
        _activateHandle: function(index) {
            ...
            // get the activated handle and start from second one
            var handle = $(this.handles).eq(index+1);
            // add class
        ...
        _refreshValue: function(animate) {
            ...
            if (numOptions) {
                ...
                ranges.each(function(i, j) {
					...
					//Get range value
					document.getElementById("chances_sgpa_weight").value = document.getElementById("SGPA").style.width;
					document.getElementById("chances_hgpa_weight").value = document.getElementById("HGPA").style.width;
					document.getElementById("chances_apps_weight").value = document.getElementById("APPS").style.width;         
