    ...
    <div class="book-container">
        <div class="chapter-view-title-container">
            ...
            <div class="book-title">
                <h5><a id="bookTitle" type="button" href="{{ route('books.page', ['id' => $chapter->book_id]) }}">{{ $book->title }}</a> by <a>{{ $author->nickname }}</a></h5>
            </div>
        ...
        <div class="chapter-description-container">
            ...
            <div class="chapter-buttons-container">
                <div class="next-chapter-button">
                    @if(isset($previousChapter->id))
                        <button><a href="{{ route('books.chapter',[ 'name' => $book->title, 'chapterId' => $previousChapter->id]) }}">Previous Chapter</a></button>
                    @endif
                </div>
                <div class="previous-chapter-button">
                    @if(isset($nextChapter->id))
                        <button><a href="{{ route('books.chapter',[ 'name' => $book->title, 'chapterId' => $nextChapter->id]) }}">Next Chapter</a></button>
                    @endif
                </div>
            </div>
        ...
        <div class="post-comment-container">
            ...
            <input value="{{ $chapterId }}" id="chapterId" hidden></input>
